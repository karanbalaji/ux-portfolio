    ...
    <section className="relative py-28 bg-gradient-to-b from-grey-50 via-background to-background dark:from-grey-900/50 dark:via-background dark:to-background">
      <div className="container px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
        ...
        <div className="space-y-4">
          <div className="inline-block px-4 py-1.5 rounded-full bg-grey-100 dark:bg-grey-800 text-grey-700 dark:text-grey-300 border border-grey-200 dark:border-grey-700 text-sm font-semibold mb-2">
            UX Case Study
          </div>
          ...
          <p className="text-xl md:text-2xl text-grey-600 dark:text-grey-300 max-w-3xl mt-4">
          ...
          <Button 
            size="lg" 
            className="bg-primary hover:bg-primary/90 text-white px-8 py-3 text-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-105"
            asChild
          >
            <Link 
