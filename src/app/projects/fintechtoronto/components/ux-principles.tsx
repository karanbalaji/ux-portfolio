        ...
        <div className="space-y-6">
          ...
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="visibility">
              ...
              <AccordionContent className="text-grey-600 dark:text-grey-50">
          ...
          <div className="text-grey-600 dark:text-grey-50 space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="p-6 rounded-lg border border-grey-200 dark:border-grey-700 bg-grey-50 dark:bg-grey-800">
                ...
                <p className="text-grey-600 dark:text-grey-50">Notification emails frame missed events as opportunities lost rather than just informational updates. The platform emphasizes what users might miss without creating negative pressure or FOMO.</p>
              </div>
              ...
              <div className="p-6 rounded-lg border border-grey-200 dark:border-grey-700 bg-grey-50 dark:bg-grey-800">
                ...
                <p className="text-grey-600 dark:text-grey-50">Strategic default settings for notification preferences are balanced between engagement and user control. Based on user research, we established reasonable defaults for update frequency that match expectations.</p>
              </div>
              
              <div className="p-6 rounded-lg border border-grey-200 dark:border-grey-700 bg-grey-50 dark:bg-grey-800">
                <h4 className="text-lg font-medium mb-3 text-grey-900 dark:text-grey-50">Anchoring</h4>
                <p className="text-grey-600 dark:text-grey-50">Feature comparison tables use strategic ordering to highlight value. Showcasing premium events first establishes value perception for all events. Testimonials are ordered to establish positive expectations.</p>
              </div>
            </div>
          </div>
        </div>
