  ...
  return (
    <section id="home" className="py-20 md:py-32 flex flex-col items-center justify-center min-h-[calc(100vh-4rem)] relative overflow-hidden">
      ...
      <div className="container px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto flex flex-col items-center text-center relative z-10">
        <div className="inline-block rounded-full bg-muted/70 backdrop-blur-sm px-3 py-1 text-sm text-muted-foreground mb-6">
        ...
        <p className="text-lg md:text-xl text-muted-foreground max-w-[600px] mb-10">
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto justify-center">
          ...
          <Button
            ...
            className="gap-2 w-full sm:w-auto backdrop-blur-sm bg-background/70"
          >
